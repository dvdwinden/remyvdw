...
<figure class="not-prose">
  ...
  <img src="/assets/google-chat-light.gif" alt="Google Chat interface" class="dark:hidden block" />
  <img src="/assets/google-chat-dark.gif" alt="Google Chat interface" class="hidden dark:block" />
